...
if choose == "About Me":
    ...
    with st.container():
        ...
        with left_column:
            ...
            st.write("📄 [Resume (1 page)](https://drive.google.com/file/d/1lsl6kVF1DwUzF7vT9OS9K_FqiLCEKnNc/view?usp=sharing)")
        with middle_column:
            st.empty()
        with right_column:
            st.image(img_utown)
...
#                 st.empty()
    ...
    resume_url = "https://drive.google.com/file/d/1lsl6kVF1DwUzF7vT9OS9K_FqiLCEKnNc/view?usp=sharing"
    st.header("Resume")
