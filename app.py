...
# Set page title
st.set_page_config(page_title="Rahul Bhanushali", page_icon = "desktop_computer", layout = "wide", initial_sidebar_state = "auto")
...
footer:after{
    content:'Copyright © 2023 Rahul Bhanushali';
    position:relative;
    color:black;
}
"""
...
with st.sidebar:
    ...
    choose = option_menu(
                        "Rahul Bhanushali", 
                        ["About Me", "Site Overview", "Experience", "Technical Skills", "Education", "Projects","Resume", "Contact"],
                         icons=['person fill', 'globe', 'clock history', 'tools', 'book half', 'clipboard', 'paperclip', 'envelope'],
    ...
    linkedin_url = "https://www.linkedin.com/in/rahul-bhanushali08/"
    github_url = "https://github.com/RahulBhanushali0809"
    #wordpress_url = "https://antcabbage.wordpress.com"
    email_url = "mailto:rahul.bhanushali0809@gmail.com"
    with st.container():
...
if choose == "About Me":
    ...
    with st.container():
        ...
        with left_column:
            ...
            st.write("💭 Ideal Career Prospects: Data Analyst, Data Scientist, Power BI developer, Data Engineer, Business Intelligence Analyst")
            st.write("📄 [Resume (1 page)](https://drive.google.com/file/d/1WsTgFTNH_6e01TnYqjSczldJQCVfHSAD/view?usp=sharing)")
        with middle_column:
            st.empty()
        with right_column:
            st.image(img_utown)
    ...
    st.markdown("""
    Upon embarking on the creation of a portfolio website in the form of an extended resume, I discovered the distinctiveness of Streamlit in comparison to conventional front-end frameworks like Angular and Bootstrap. Streamlit, predominantly employed as a web application for dashboarding, showcases a plethora of features that enhance its visual appeal when compared to alternatives like Plotly and Shiny. Leveraging the accessibility of Python as a beginner-friendly programming language, I have resolved to transform this personal project into a time capsule—a repository of noteworthy moments and achievements since the commencement of my formal education. Furthermore, if successful in completing this endeavor, I intend to contribute my code as an open-source resource, thereby enabling other students to document their educational journey in a similar fashion.
    
    By leveraging Streamlit's collaborative features, such as real-time updates and interactive components, we can actively engage in the exploration and interpretation of data, promoting a collaborative and dynamic analytical environment. Thus, Streamlit and Python provide an ideal combination for streamlined analysis, simplified dashboard creation, and efficient collaboration among stakeholders.
...
# Create section for Work Experience
    ...
    with st.container():
        ...
        with image_column:
            st.image(img_Continental)
        with text_column:
            st.subheader("Data Analyst (Werkstudent), [Continental](https://www.continental.com/de/)")
            st.write("*May 2023 to Present*")
            st.markdown("""
            - Developed and published a comprehensive end to end Power BI dashboard that provides detailed budget vs. actual cost reporting across more than 15 projects, delivering consolidated insights to over 10 stakeholders.
            
            - Created a highly optimized Power BI dashboard for product validation timeline, resulting in a 20% reduction in project costs and improving task efficiency across 10 project segments.
            
            - Automated the process of fetching, transforming, and loading monthly data files into Excel using Visual Basic, resulting in a remarkable time reduction from approximately 2 hours to approximately 3 minutes.
            
            - Designed and implemented a robust full-stack Power BI dashboard for demand volume analysis, enabling effective supplier capacity management and facilitating in-depth demand vs. supply analytics for 15 different product groups.
            
            
            `Microsoft Power BI` `SAP` `MS Excel` `Datalake` `VBA`
            """)
            st.markdown("""Project Manager:""")
            st.write("[Mr. Stefan Schantz](mailto:Stefan.Schantz@continental-corporation.com)")
    with st.container():
        image_column, text_column = st.columns((1,5))
        with image_column:
            st.image(img_tcs)
        with text_column:
            st.subheader("ASSOCIATE SYSTEM ENGINEER, [TATA CONSULTANCY SERVICES](https://www.tcs.com/)")
            st.write("*July 2019 to February 2021*")
            st.markdown("""
            - Proficiently utilized SQL database queries as part of ETL processes to extract more than 30 million data records from the database for reporting purposes, effectively aligning with business requirements. 

            - Performed tuning activities, optimizing various data objects such as tables, views, stored procedures, functions, packages, and triggers.

            - Successfully maintained and optimized data warehouse and data lake, ensuring smooth operation and data integrity.

            `SQL Queries` `Relational Database` `ETL Pipeline` `Datalake` 
            """)
            st.write("[Letter of Recommendation](https://drive.google.com/file/d/10oUojzPsTf1HeEL4kDjpEA5AUL_mtRI9/view?usp=sharing)")
...
# Create section for Technical Skills
    ...
    txt3("Programming Languages","`Python`, `SQL`, `R`, `Java`, `DAX`, `MATLAB`")
    txt3("Academic Interests","`Data Visualization`, `Supply-Demand Analysis`, `Acutal vs Budget Cost analysis`, `KPI Analysis`, `Market Basket Analysis`, `Recommendation Systems`, `ETL Pipeline Creations`, `Natural Language Processing`")
    txt3("Data Visualization", "`Power BI`, `Plotly`, `ipyvizzu`, `matplotlib`, `seaborn`, `Tableau`, `Google Analytics`")
    txt3("Database Systems", "`MySQL`, `PostgreSQL`, `PL/SQL`, `NoSQL`, `T-SQL`")
    ...
    txt3("Data Science Techniques", "`Regression`, `Clustering`, `Corelation Detection`, `Association Rules Mining`, `Key Feature Selection`, `Random Forest`, `Decison Trees`, `Principal Components Analysis`, `Text Classification`, `Sentiment Analysis`")
    txt3("Machine Learning Frameworks", "`Numpy`, `Pandas`, `Scikit-Learn`")
    txt3("Task Management Tools", "`Jira`")
    txt3("Miscellaneous", "`Microsoft Office`, `MS Teams`")
...
#                 st.empty()
    ...
    with st.container():
        ...
        with text_column:
            st.subheader("Power BI Dashboard: Identification and Interpretation of User Type Clusters")
            st.write("*Project for research purpose of understanding Enterprise Collaboration System (ECS) tool at University of Koblenz under the guidance of:*")
            ...
            st.markdown("""
            Research questions: 
            - What are the important dimensions of users to be considered while applying Social Media analytics?
            - What are the possible roles of users based on different dimensions of users on social media?
            """)
            st.write("[Project Report](https://drive.google.com/file/d/1IWNZF8lWbjW5xV4Yq4q5eKja8-zjOtEZ/view?usp=sharing)")
            #mention(label="Github Repo", icon="github", url="https://github.com/harrychangjr/blockchain-webscraping",)
        with image_column:
              st.image(images_BI_Dashboard)
    with st.container():
        text_column, image_column = st.columns((3,1))
        with text_column:
            st.subheader("Research Project - AI & COVID")
            st.write("*End to end Research Project as a part of Research Lab at University of Koblenz under the guidance of:*")
            st.write("[Prof. Dr. Maria Wimmer](https://www.uni-koblenz-landau.de/de/koblenz/fb4/iwvi/agvinf/team/maria-wimmer)")
            st.markdown("""
            Project Scope:
            - Collection of COVID related historic data such as number of infection (new, total, and weekly), recovery, and hospitalization of Rhineland Palatinate and its districts. The official data sources will from be state statistical official (Landesuntersuchungsamt) of Rhineland Palatinate state in Germany.
            - Creation of ETL Pipeline in a database and schema to store the historic data. A supporting software application interface has to be developed to periodically update the database with latest dataset.
            - Analysis of the dataset and investigating key factors (vaccination rate, demographics, age, health condition, social connectedness, interventions, occupation etc.) which might influence the rate of infection.
            - Development of Machine Learning algorithm to forecast the trend of infection for the upcoming weeks.
            
            Research Questions:
            - What is the trend of COVID-19 infection in different cities of Rhineland Palatinate state (Germany) over a selected time interval?
            - How might the infection trend look (forecast) in the following weeks?
            """)
            st.write("[Project Report](https://drive.google.com/file/d/1HuhyEVSsXJ5GQ9uhU1M7osX5QbUh8IWX/view?usp=sharing)")
            # st.write("[Github Repo](https://github.com/harrychangjr/sales-prediction)")
               
        with image_column:
            st.image(images_tableau)
    with st.container():
        text_column, image_column = st.columns((3,1))
        with text_column:
            st.subheader("Amazon Sales Data Analysis")
            st.write("*Internship Project as a part of iNeuron organization*")
            st.markdown("""
            - Task: Find key metrics and factors and show the meaningful relationships between attributes. enterprise.
            """)
            # st.write("[Github Repo](https://github.com/harrychangjr/sales-prediction)")
            mention(label="Github Repo", icon="github", url="https://github.com/RahulBhanushali0809/amazon_sales_data_analysis.git",)
        with image_column:
            st.image(images_cert_1)
    with st.container():
        text_column, image_column = st.columns((3,1))
        with text_column:
            st.subheader("News Article Classifier using Machine Learning")
            st.write("*Internship Project as a part of iNeuron organization*")
            st.markdown("""
            ...
            - Objective: To build a solution that should recognize and classify the news articles based on their labels.

            - Benefits: Easy and fast classification of news articles for better user experience.
            """)
            #st.write("[Github Repo](https://github.com/harrychangjr/sp1541-nlp)")
            mention(label="Github Repo", icon="github", url="https://github.com/Rahul-Bhanushali/news_classifier.git",)
        with image_column:
            st.image(images_news)
    ...
    resume_url = "https://drive.google.com/file/d/1WsTgFTNH_6e01TnYqjSczldJQCVfHSAD/view?usp=sharing"
    st.header("Resume")
...
# Create section for Contact
    ...
    with st.container():
        ...
        with text_column:
            st.write("Let's connect! You may either schedule a meeting on https://calendly.com/rahul-bhanushali0809/30min or reach out to me at Mobile: (+49) 15734107273 !")
